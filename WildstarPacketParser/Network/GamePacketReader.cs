...
namespace WildstarPacketParser.Network
{
    public class Packet : IDisposable
    {
        ...
        private byte ReadByte(uint bits = 8u)
        {
        ...
        private ushort ReadUShort(uint bits = 16u)
        {
        ...
        private short ReadShort(uint bits = 16u)
        {
        ...
        private uint ReadUInt(uint bits = 32u)
        {
        ...
        private int ReadInt(uint bits = 32u)
        {
        ...
        private float ReadSingle(uint bits = 32u)
        {
        ...
        private double ReadDouble(uint bits = 64u)
        {
        ...
        private ulong ReadULong(uint bits = 64u)
        {
        ...
        private T ReadEnum<T>(uint bits = 64u) where T : Enum
        {
            if (bits > sizeof(ulong) * 8)
                throw new ArgumentException();
        ...
        private string ReadWideStringFixed()
        {
